<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Tiket • {{ $event->judul }}</h2>
    </x-slot>

    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <form action="{{ route('admin.events.tikets.store', $event) }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="tipe" class="mt-1 w-full rounded-lg border-gray-200 focus:border-gray-400 focus:ring-gray-400">
                            ...
                            <option value="reguler" @selected(old('tipe')==='reguler')>Reguler</option>
                            <option value="premium" @selected(old('tipe')==='premium')>Premium</option>
                        </select>
